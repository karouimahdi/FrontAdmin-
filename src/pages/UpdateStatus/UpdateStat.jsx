...
const SingleC = () => {
  ...
  const handleSubmiteC = () => {
    ...
    // Handle validations
    axios
      .put(`https://backend-admin-iota.vercel.app/Chauff/updatestatuss/${id}`
      ,{ headers: {
  ...
  .catch(err =>{
    ...
    const handleSubmite = () => {
        ...
        // Handle validations
        axios
          .put(`https://backend-admin-iota.vercel.app/agent/updatestatuss/${id}`
          ,{ headers: {
            'Content-Type': 'multipart/form-data',
          },})
    ...
    const handleSubmiteCl = () => {
      ...
      // Handle validations
      axios
        .put(`https://backend-admin-iota.vercel.app/Client/updatestatuss/${id}`
        ,{ headers: {
          'Content-Type': 'multipart/form-data',
        },})
